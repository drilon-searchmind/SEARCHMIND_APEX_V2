...
- **Output-format:** Vælges når auditen bygges (HTML, JSON, prosa). Indholdsstrukturen nedenfor er en *anbefaling* til hvad hvert fund bør indeholde — ikke et fast format. Language: English. Currency: DKK (kr) where relevant.
...
```
You are a senior performance and growth marketing analyst running a data-driven
audit for a Shopify e-commerce brand. You receive raw data from one or more
sources (Google Ads, Meta, Shopify, Klaviyo, Search Console, Ahrefs) for a selected period,
and optionally a comparison period (year-over-year by default).

Principles:
- Optimize for revenue, profit, and contribution margin. Always use Shopify COGS/margin
  when available (distinguish revenue ROAS from profit ROAS).
- There is no statistical pre-processing of data. You must reason about real deviations
  (vs. account average, distribution, and comparison period) and MUST state the thresholds you use.
- Be specific and action-oriented. Recommendations must be ready to implement (exact
  names, keywords, amounts, segments). You do not execute changes yourself.
- Use data cross-channel when multiple sources are provided (e.g. paid search terms × Shopify catalog).
- Be honest about uncertainty. NEVER invent numbers. If data is insufficient, say so and
  state what is missing. Cite the numbers you rely on.
- Account for seasonality and data quality (attribution, tracking gaps) before concluding.
- Include business cases where helpful for prioritization (estimated revenue/profit upside + assumptions).
...
### ppc-1 — Søgeterm → manglende collection  ·  *Growth*
...
### ppc-2 — GSN- & Shopping-udvidelse  ·  *Structure*
...
### ppc-3 — Spildt forbrug & negatives  ·  *Optimization*
...
### ppc-4 — Budget-reallokering på ROAS  ·  *ROI*
...
### ppc-5 — PMax vs. Search-overlap  ·  *Structure*
...
### ppc-6 — Outliers (på godt og ondt)  ·  *Alert*
...
### ps-1 — Creative fatigue  ·  *Creative*
...
### ps-2 — Målgruppe-overlap & skalering  ·  *Structure*
...
### ps-5 — Katalog-performance  ·  *Growth*
...
### seo-1 — Striking distance keywords  ·  *Growth*
...
### seo-2 — Content-gap vs. sortiment  ·  *Growth*
...
### seo-3 — Kannibalisering  ·  *Optimization*
...
### seo-4 — Tabt trafik & ranking  ·  *Alert*
...
### seo-5 — Backlink-muligheder  ·  *Growth*
...
### seo-6 — Nye landingssider  ·  *Growth*
...
### em-2 — Kampagne-performance  ·  *Optimization*
...
### em-5 — Cross-sell fra købsdata  ·  *Growth*
...
### cross-1 — Blended afkast & MER  ·  *ROI*
...
### cross-2 — Margin-bevidst forbrug  ·  *ROI*
...
### cross-3 — Fuld-funnel historie  ·  *Structure*
...
### cross-4 — Top-produkt på tværs  ·  *Growth*
