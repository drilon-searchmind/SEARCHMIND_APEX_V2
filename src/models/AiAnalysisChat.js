...
const AiAnalysisChatSchema = new mongoose.Schema({
    ...
    dashboardType: {
        type: String,
        enum: ['performance-dashboard', 'daily-overview', 'seo-dashboard', 'ppc-dashboard', 'ps-dashboard', 'pinterest-dashboard', 'snapchat-dashboard', 'pace-report', 'pnl', 'ecommerce', 'analytics', 'parent-property', 'share-of-search', 'other'],
        default: 'other',
        index: true
    }
}, {
