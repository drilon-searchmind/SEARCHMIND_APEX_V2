...
const FormButton = ({ children, buttonSize, borderType, disabled = false }) => {
    ...
    return (
        <Button type="submit" className={`w-full rounded-lg ${buttonSizeClass} ${borderClass}`} disabled={disabled}>
            {children}
        </Button>
    )
}
