...
export default function CustomerPerformance({ segmentation = null, loading = false, ltvLoading = false, ltvError = null }) {
    ...
    // Use stub when loading so we show layout with placeholders
