        ...
        (async () => {
            try {
                ...
                const [curRes, prevRes] = await Promise.all([
                    fetch(`/api/snapchat-dashboard?${q(appliedRange.startDate, appliedRange.endDate)}`),
                    fetch(`/api/snapchat-dashboard?${q(prevStartStr, prevEndStr)}`),
                ]);
                    ...
                    <GraphCard
                        title={
                            (selectedMetrics || []).length === 1 && (selectedMetrics || [])[0]
                                ...
                                : `Multiple Snapchat metrics vs ${comparisonMethod}`
                        }
