...
function dimsFromWidth(containerWidth) {
    ...
    if (w < 480) {
        return {
            ...
            marginy: 22,
            boxMinH: 110,
            labelClass: "text-xs font-semibold uppercase tracking-wide text-neutral-400",
    ...
    if (w < 640) {
        return {
            ...
            marginy: 30,
            boxMinH: 120,
            labelClass: "text-sm font-semibold uppercase tracking-wide text-neutral-400",
    ...
    return {
        ...
        marginy: 42,
        boxMinH: 158,
        labelClass: "text-base font-semibold uppercase tracking-wide text-neutral-400",
