...
/**
 * PATCH /api/apex-radar/google-ads/customer-settings/[customerId]
 */
export async function PATCH(request, { params }) {
    ...
    try {
        ...
        return NextResponse.json({
            ...
            customerApexRadarSettings: { google },
        });
    } catch (e) {
        console.error("[apex-radar/google-ads/customer-settings PATCH]", e);
