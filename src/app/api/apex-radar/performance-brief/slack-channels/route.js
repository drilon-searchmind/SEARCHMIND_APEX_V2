...
import { listPerformanceBriefSlackChannels } from "@/lib/performanceBriefSlack";

/**
 * GET /api/apex-radar/performance-brief/slack-channels
 */
export async function GET() {
    ...
    try {
        ...
        console.error("[apex-radar/performance-brief/slack-channels GET]", e);
