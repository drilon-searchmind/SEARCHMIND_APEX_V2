...
import {
    ...
    resolveAgenticShopifyqlApiVersion,
...
async function runShopifyql(type, shopUrl, accessToken, startDate, endDate, isDemo) {
    ...
    if (type === "AgenticSalesReport") {
        ...
        const report = await fetchAgenticSalesChannelReport({
            shopUrl,
            accessToken,
            startDate,
            endDate,
        ...
        return {
            ...
            note: report.note,
            allSalesChannelsSample: report.allSalesChannelsSample,
        };
    }

    if (type === "AgenticReferringReport") {
        const apiVersion = await resolveAgenticShopifyqlApiVersion(shopUrl, accessToken);
        const report = await fetchAgenticReferringChannelReport({
            shopUrl,
            accessToken,
            startDate,
            endDate,
        ...
        return {
            ...
            allReferrerSourcesSample: report.allReferrerSourcesSample,
        };
    }
