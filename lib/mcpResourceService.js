...
import {
    ...
    listMcpExtendedCustomerResources,
    listMcpExtendedGlobalResources,
...
export const MCP_GLOBAL_RESOURCES = [
    "internal-users",
    "parent-customers",
    ...listMcpExtendedGlobalResources(),
];
...
export async function fetchMcpCustomerResource(customerId, resource, query = {}) {
    ...
    switch (resource) {
        ...
        default:
            return fetchMcpExtendedCustomerResource(id, resource, query);
    }
}
 ...
 * @param {Record<string, string | undefined>} [query]
 */
export async function fetchMcpGlobalResource(resource, query = {}) {
    switch (resource) {
        case "internal-users":
        ...
        default:
            return fetchMcpExtendedGlobalResource(resource, query);
    }
}
