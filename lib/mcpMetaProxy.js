...
import { demoCatalogPayload, fetchMcpMetaCatalogProducts } from "@root/lib/mcpMetaCatalog";
    ...
    switch (endpoint) {
        ...
        case "ads-with-creatives":
            return {
                ...
                summary: {
                    total: 1,
                    withThumbnailOrImage: 1,
                    withFullImage: 1,
                    byObjectType: { VIDEO: 1 },
                    byFullImageSource: { video_thumbnail: 1 },
                },
            };
        case "ad-preview":
            return {
        ...
        case "catalog-products":
            return { demo: true, ...demoCatalogPayload() };
        default:
            throw new Error(`Unknown Meta endpoint: ${endpoint}`);
    }
}
