...
export async function fetchMcpShopifyChannelAttribution(customerId, params = {}) {
    ...
    const [salesByChannel, trafficByReferrerSource, trafficByUtmSource] = await Promise.all([
    ...
    return {
        ...
        trafficByUtmSource,
        notes: [
            "salesByChannel: revenue/orders grouped by Shopify sales_channel (Online Store, POS, etc.)",
