...
export function serializeCustomerForMcp(customer) {
    ...
    if (type === "WooCommerce") {
        ...
        storeConfigured =
            hasNonEmpty(cs.danDomainOriginal?.shopAdminUrl) &&
            hasNonEmpty(cs.danDomainOriginal?.apiKey);
    } else {
    ...
    return {
        ...
        revenueDisplayVat:
            cs.revenueDisplayVat === "incl" ||
            cs.revenueDisplayVat === "incl_shopify"
                ? cs.revenueDisplayVat
                : "excl",
